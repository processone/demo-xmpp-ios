...
8. Open your `AppDelegate.h` and add the XMPP import: `#import <XMPPFramework/XMPPFramework.h>`
9. Finito ! Build & run to confirm everyting is setup properly before going further



### II.XMPP Demo
1. Add the following to your `AppDelegate.h`:  
`#import <XMPPFramework/XMPPRoster.h>` and `#import <XMPPFramework/XMPPRosterCoreDataStorage.h>`
